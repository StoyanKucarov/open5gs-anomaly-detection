#!/usr/bin/env python3
"""
models/traces/plot_results.py

Generates visualisations from eval_results.json produced by evaluate.py.
Re-run freely without re-training.

Outputs (models/traces/out/)
-----------------------------
  eval_auroc_heatmap.png
  eval_f1_heatmap.png       (Average Precision / PR-AUC)
  eval_recall_heatmap.png
...
def plot_heatmap(results: list[dict], metric: str,
    ...
    ax.set_title(f"Per-Fault {label_str} — Trace Anomaly Detection\n"
